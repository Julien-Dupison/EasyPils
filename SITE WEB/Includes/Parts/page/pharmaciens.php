		...
		<div class="col-lg-8 col-sm-8">
			<div class="profile-container">
    			<div class="card hovercard">
        			...
        			<div class="useravatar">
						<a id="opt-pharm"><i class="fa fa-cog" aria-hidden="true"></i></a>
            			<img alt="" src="<?php echo $_SESSION['img_pharm_easypils'] ?>">
        			</div>
	        		<div class="card-info"> <span class="card-title"><?php echo $_SESSION['prenom_pharm_easypils']." ".$_SESSION['nom_pharm_easypils'] ?></span></div>
	    		</div>
			...
			<div class="custom-panel">
				...
				<div class="custom-panel-header">
					Liste Pharmaciens
					<input id="pharmacien-search" class="custom-searchinput2 pull-right" style="font-weight:normal;font-size:15px;color:#000000;" placeholder="Recherche..."></input>
				</div>

				<div class="custom-panel-content" style="padding:0;">
					<table id="table-pharmacien" class="table table-hover" style="margin-bottom:0;">
					</table>
				</div>

				<div class="custom-panel-footer">
					<div style="float:left;">
						<button value="5" class="pharmacien-qte btn btn-danger-custom">5</button>
						<button value="10" class="pharmacien-qte btn btn-danger-custom">10</button>
						<button value="15" class="pharmacien-qte btn btn-danger-custom">15</button>
					</div>
					<div style="text-align:right;">
						<button id="pharmacien-moins" class="btn btn-accent"><</button>
						<button id="pharmacien-plus" class="btn btn-accent">></button>
					</div>
				</div>
			...
			<div class="custom-panel">
				...
				<div id="panel-content-pharm-form" class="custom-panel-content panel-collapse collapse in">
					<form method="post">
						...
						<label>Mail :</label>
						<input type="email" id="new-pharm-mail" class="form-control"><br>
						<label>Adresse :</label>
				...
				<div id="panel-content-pharm-form" class="custom-panel-footer">
					<div style="text-align:right;">
						<button id="button_add_pharmacien" class="btn btn-accent">Ajouter&nbsp;&nbsp;&nbsp;<i class="fa fa-plus"></i></button>
					</div>
				</div>
			</div>
		</div>
