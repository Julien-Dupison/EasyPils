<?php
	...
	if($ordonnance != null){
		...
		$sql = "SELECT R.date_renouv, P.nom_pharm, P.prenom_pharm FROM renouvellements R, pharmaciens P WHERE R.id_pharm = P.id_pharm AND R.id_ordo = $id_ordo";
		$renouvellements = $db->query($sql)->fetchAll(PDO::FETCH_ASSOC);
